    ...
    function radioTable(foodtype) {
        ...
        $.ajax({
            ...
            success: function (response) {
                for (var i = 0; i < response.length; i++) {
                    ...
                    htmlNormal += "<tr><td><input type='radio' class='minimal' name='normalfood[]'"+
                        "value='"+response[i]['fooditems']+"'>&nbsp;" +
                        response[i]['fooditems'] + "</td></tr>";
                }
                $('#tableNormal').html(htmlNormal);
            }
        });
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $('#tableSpecific').html(htmlSpecific);
            }
        });
    }
            ...
            <form action="" method="post" id="frmData">
                <div class="table-responsive" style="text-align: center;">
                    <table class="col-sm-8 offset-sm-2 table-borderless " id="tableData">
                        ...
                        <tr>
                            ...
                            <input type="hidden" name="ptname" value="<?= $res['ptname']; ?>"
                        </tr>
                ...
                <div id="divradio" class="table-responsive">
                    <table class="col-sm-8 offset-sm-2 table-bordered">
                        ...
                        <td width="50%" valign="top">
                            <table class="table-borderless" id="tableNormal">
                               <tbody></tbody>
                            </table>
                        </td>

                        <td width="50%" valign="top">
                            <table class="table-borderless" id="tableSpecific">
                               <tbody></tbody>
                            </table>
                        </td>
                        </tr>
                ...
                <div id="div6" class="table-responsive">
                    <table class="col-sm-8 offset-sm-2 table-borderless">
                        ...
                        <tr>
                            <td width="33%">
                                <input type="radio" class="minimal" name="intensity" value="1:1">&nbsp;1:1
                            </td>
